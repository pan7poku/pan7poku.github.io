...
fetchAllPages();  };
 ...
 var gg1= function(){const papa=nextLink.length;
  function fetchAllPages(keyword, pageUrl, collected, maxPages){   if(papa > 5){  pageUrl = nextLink;}else{pageUrl = 'https://nettestfffx.blogspot.com/search?q='+gonzu;}
...
fetchAllPages(); };
 ...
 document.getElementById("sendBtn").addEventListener("click", function() {let jaa="";nextLink="";
  gonzu= document.getElementById("chatInput").value;ga.append('<div class="message user"><span>'+gonzu+'</span></div>');
    ...
    if (gonzu.includes("配信") && gonzu.includes("終了")) {ga.append(`<div class="message bot"><span>💡 Netflixの配信終了作品は以下のページでご確認ください。<br/><br/>✅ 配信終了作品<br/><a href="https://nettestfffx.blogspot.com/p/netflix-expiring.html" target="_blank" rel="noopener noreferrer" class="aftehurr345">https://nettestfffx.blogspot.com/p/netflix-expiring.html</a><br/><br/>✅ 過去の配信終了作品<br/><a href="https://nettestfffx.blogspot.com/p/netflix-leaved-all.html" target="_blank" rel="noopener noreferrer" class="aftehurr345">https://nettestfffx.blogspot.com/p/netflix-leaved-all.html</a></span></div>`);}else if (gonzu.includes("配信予定")) {ga.append(`<div class="message bot"><span>✅ Netflix配信予定掲載ページ<br/><a href="https://nettestfffx.blogspot.com/p/netflix-coming-soon.html" target="_blank" rel="noopener noreferrer" class="aftehurr345">https://nettestfffx.blogspot.com/p/netflix-coming-soon.html</a></span></div>`);}else if (mi.includes("モード")) {
     ...
     if (mi.includes("or")) {nu0=nu2;ga.append('<div class="message bot"><span>✅ 検索モードを <b>or</b> に切り替えました。</span></div>');} else if (mi.includes("and")){ nu0=nu1;ga.append('<div class="message bot"><span>✅ 検索モードを <b>and</b> に切り替えました。</span></div>');}else{ga.append('<div class="message bot"><span>⚠️ モードは「and」または「or」で指定してください。</span></div>');}}else{   ga.append('<div class="message bot"><span>⏳ 作品を検索中です...</span></div>'); gonzu=gonzu.replace(/ /g, nu0).replace(/　/g, nu0);
      ...
      if (mi.includes("海外") && mi.includes("tv")) {jaa='<br/>💡 海外TVドラマライナップ一覧は以下のページでもご確認できます。<br/><p class="sentanko88"><a href="https://nettestfffx.blogspot.com/p/netflix-drama-line-up.html" target="_blank" rel="noopener noreferrer" class="aftehurr345">https://nettestfffx.blogspot.com/p/netflix-drama-line-up.html</a></p>'}
      
      ga.append('<div class="message bot"><span><p class="sentanko88">📝Get Freax 検索ワード一覧URL<br/><a href="https://nettestfffx.blogspot.com/search?q='+gonzu+'&max-results=20" target="_blank" rel="noopener noreferrer" class="aftehurr345">https://nettestfffx.blogspot.com/search?q='+gonzu+'</a></p>'+jaa+'</span></div>');
 gg1();}});
