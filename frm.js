...
$(function () {
    ...
    fetch(url, {
        ...
        .then(function (huu) {
                ...
                if (tecn < 5) {
                    ...
                    $(function () {
                        ...
                        for (var i = 0; i < 5; i++) {
                            ...
                            // const acn2 = new Object(acn0);
                            // const imga = acn2.replace(/"/g,"");
                            // const acn1 = acn2["profile_path"];
                        }
                    });
                    // for1 en
                    // for 2nd
            ...
            // gazou en
            // ref4.innerHTML = JSON.stringify(huu["credits"]);
            // result1.innerHTML = rezo8;
            // result3.innerHTML = puu;
        })
        .catch(function (error) {
            $(error).hide();
        });
                ...
                fetch(url65, {
                    ...
                    .then(function (huutv) {
                        $(function () {
                            ...
                            const pos1 = pos.replace(/"/g, "");
                            const pos2 = "https://image.tmdb.org/t/p/w500" + pos1;
                            // const tvl = huutv['networks'];
                            // const allt = new Object(tvl);
                            // const poszz = JSON.stringify(allt[0]['logo_path']);
                            // const tvp = poszz.replace(/"/g,"");
                            // const tvp2 = "https://image.tmdb.org/t/p/w500" + tvp;
                            if (fxxetx > 10) {
                                $('blockquote').append(memo1);
                                $('#postted').attr('src', pos2);
                                const result1 = document.getElementById("sectiona22");
                                result1.innerHTML = fxxe;
                                // $('#sectiona222-l').attr('src', tvp2);
                                $(".second-btn").click(function () {
                                    $(".ssbackg-bq").show();
                                    $(".second-btn").hide();
                                    $(".ssbackg-bq").addClass("fade-main2");
